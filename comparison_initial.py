...
if ref_file and cmp_file:
    ...
    if df_ref is not None and df_cmp is not None:
        ...
        with tab1:
            ...
            fig.add_trace(go.Scatter3d(
                x=survey_cmp.e, y=survey_cmp.n, z=survey_cmp.tvd,
                mode='lines', name='Comparative Survey', line=dict(color='red')
            ))

            # Set fixed aspect ratio to prevent axis scaling while rotating
